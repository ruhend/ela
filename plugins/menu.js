  ...
  try {
   ...
   const sections = [
   {
	...
	rows: [
	    ...
	    {title: `📔 ${pmenus} INFO 𝙱𝙾𝚃`, rowId: ".sc", description: `INFO ${namebot}`},
	]
    },{
...
╭━━━━━━━━━━━━━━━━┈─✧
┴
│⬡ *Welcome To RuHender Bot*
│⬡ Youtube :
│     youtube.com/rulichannel
│⬡ Sewa Bot? :
│     wa.me/6283122886524
│⬡ Grup Whatsapp 👇:
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://youtube.com/rulichannel'
                    }
                },
                {
                    urlButton: {
